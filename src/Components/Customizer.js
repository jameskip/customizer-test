...
export default class Customizer extends React.Component {
  constructor (props) {
    ...
    this.embellish = JSON.stringify({ 'prepared': { 'itemid': '2592', 'itemkeyid': 'al-state-bird', 'itembasekey': '/standard/state/al-state-bird', 'premium': false } }) // window.YETI.customizer.setJSON()
